...
async function main() {
  ...
  const questionData = [
    ...
    { key: "two_seater", text: "Does it have just two seats, with no back seats at all?", category: "body_style" },
  ...
  const carRoster = [
    ...
    { make: "Toyota", model: "MR2 (SW21)", year: 1991, tags: ["rwd", "manual", "coupe", "japanese", "mid_engine", "popups", "two_seater", "wedge", "us_market"] },//
    { make: "Nissan", model: "Skyline GT-R (R34)", year: 1999, tags: ["awd", "manual", "turbo", "twin_turbo", "inline6", "coupe", "japanese", "fast_furious", "round_taillights", "big_wing"] },//
    { make: "Nissan", model: "Skyline GT-R (R33)", year: 1995, tags: ["awd", "manual", "turbo", "twin_turbo", "inline6", "coupe", "japanese", "round_taillights", "big_wing"] },//
    { make: "Nissan", model: "Skyline GT-R (R32)", year: 1999, tags: ["awd", "manual", "turbo", "twin_turbo", "inline6", "coupe", "japanese", "initial_d", "godzilla", "big_wing", "round_taillights"] },//
    { make: "Nissan", model: "GT-R (R35)", year: 2020, tags: ["awd", "turbo", "twin_turbo", "v6", "coupe", "japanese", "six_figure", "over_400hp", "us_market", "round_taillights"] },//
    { make: "Nissan", model: "Fairlady Z (RZ34)", year: 2023, tags: ["rwd", "manual", "liftback", "turbo", "twin_turbo", "v6", "coupe", "japanese", "two_seater", "over_400hp", "us_market"] },//
    { make: "Nissan", model: "180SX (RPS13)", year: 1991, tags: ["rwd", "manual", "turbo", "liftback", "coupe", "japanese", "popups"] },//
    { make: "Nissan", model: "Silvia (PS13)", year: 1991, tags: ["rwd", "manual", "turbo", "coupe", "japanese", "boxy"] },//
    { make: "Nissan", model: "Silvia Spec-R (S15)", year: 1999, tags: ["rwd", "manual", "turbo", "coupe", "japanese"] },//
    { make: "Nissan", model: "Altima SR (L34)", year: 2018, tags:[ "sedan", "japanese","awd"]},
    { make: "Mazda", model: "RX-7 (FD)", year: 1993, tags: ["rwd", "manual", "turbo", "twin_turbo", "rotary", "coupe", "japanese", "popups", "fast_furious", "initial_d", "two_seater", "round_taillights", "redline_8k", "us_market"] },
    { make: "Mazda", model: "RX-8", year: 2004, tags: ["rwd", "manual", "rotary", "sedan", "japanese", "unusual_doors", "redline_8k", "us_market"] },
    { make: "Mazda", model: "MX-5 Miata (NA)", year: 1990, tags: ["rwd", "manual", "convertible", "japanese", "popups", "two_seater", "lightweight", "us_market"] },
    { make: "Mazda", model: "MX-5 Miata (ND)", year: 2023, tags: ["rwd", "manual", "convertible", "japanese", "two_seater", "us_market"] },
    ...
    { make: "Mitsubishi", model: "Lancer Evolution VIII (CT9A)", year: 2004, tags: ["awd", "manual", "turbo", "sedan", "japanese", "fast_furious", "big_wing", "wrc", "us_market"] },
    { make: "Toyota", model: "Sprinter Trueno (AE86)", year: 1985, tags: ["rwd", "manual", "liftback", "japanese", "popups", "initial_d", "lightweight"] },
    { make: "Toyota", model: "Celica GT-Four (ST205)", year: 1994, tags: ["awd", "manual", "turbo", "liftback", "coupe", "japanese", "wrc"] },
    { make: "Toyota", model: "GR Corolla", year: 2023, tags: ["awd", "manual", "turbo", "hatchback", "japanese", "us_market"] },
    { make: "Nissan", model: "350Z (Z33)", year: 2006, tags: ["rwd", "manual", "v6", "coupe", "liftback", "japanese", "fast_furious", "two_seater", "us_market"] },
    ...
    { make: "Toyota", model: "Hilux (RN110)", year: 1988, tags: ["awd", "manual", "truck", "japanese"] }, //done

    // AMERICAN & TRUCKS HELL YA BROTHER
    { make: "Ford", model: "Mustang GT (S650)", year: 2024, tags: ["rwd", "manual", "v8", "coupe", "american", "over_400hp", "us_market"] },
    { make: "Dodge", model: "Charger R/T (B-Body)", year: 1970, tags: ["rwd", "manual", "v8", "coupe", "american", "fast_furious", "us_market"] },
    { make: "Chevrolet", model: "Corvette (C8)", year: 2023, tags: ["rwd", "v8", "coupe", "american", "mid_engine", "two_seater", "over_400hp", "us_market"] },
    { make: "Chevrolet", model: "Corvette Sting Ray (C2)", year: 1963, tags: ["rwd", "manual", "v8", "coupe", "american", "two_seater", "us_market"] },
    { make: "Chevrolet", model: "Camaro ZL1 (6th Gen)", year: 2018, tags: ["rwd", "manual", "v8", "turbo", "coupe", "american", "over_400hp", "us_market"] },
    { make: "Ford", model: "GT", year: 2005, tags: ["rwd", "manual", "v8", "turbo", "coupe", "american", "mid_engine", "two_seater", "six_figure", "limited_run", "over_400hp", "us_market"] },
    { make: "Dodge", model: "Viper GTS", year: 1996, tags: ["rwd", "manual", "big_cyl", "coupe", "american", "two_seater", "over_400hp", "us_market"] },
    { make: "Buick", model: "Regal Grand National", year: 1987, tags: ["rwd", "turbo", "v6", "coupe", "american", "boxy", "us_market"] },
    ...
    { make: "Ford", model: "F-150 Raptor (P702)", year: 2021, tags: ["awd", "turbo", "twin_turbo", "v6", "truck", "american", "boxy", "over_400hp", "us_market"] },
    { make: "Jeep", model: "Wrangler (JL)", year: 2024, tags: ["awd", "manual", "suv", "american", "convertible", "boxy", "us_market"] },
    { make: "Ford", model: "Bronco", year: 2021, tags: ["awd", "manual", "suv", "american", "convertible", "boxy", "us_market"] },
    ...
    { make: "Pontiac", model: "Firebird Trans Am (Third Gen)", year: 1982, tags: ["rwd", "v8", "coupe", "american", "popups", "knight_rider", "wedge", "us_market"] },

    //  EUROPEAN
    { make: "Porsche", model: "911 Carrera (992)", year: 2024, tags: ["rwd", "manual", "turbo", "twin_turbo", "coupe", "european", "boxer", "german", "rear_engine", "us_market"] },
    { make: "Porsche", model: "911 GT3 (997)", year: 2007, tags: ["rwd", "manual", "coupe", "european", "boxer", "german", "rear_engine", "redline_8k", "big_wing", "six_figure", "over_400hp", "us_market"] },
    { make: "Porsche", model: "944 Turbo", year: 1986, tags: ["rwd", "manual", "turbo", "coupe", "european", "popups", "german", "us_market"] },
    ...
    { make: "Volkswagen", model: "Golf GTI (MK8)", year: 2024, tags: ["fwd", "manual", "turbo", "hatchback", "european", "german", "us_market"] },
    ...
    { make: "BMW", model: "M3 (E30)", year: 1988, tags: ["rwd", "manual", "coupe", "european", "german", "boxy", "us_market"] },
    { make: "BMW", model: "M3 (E46)", year: 2000, tags: ["rwd", "manual", "inline6", "coupe", "european", "german", "redline_8k", "us_market"] },
    { make: "BMW", model: "M3 (E92)", year: 2010, tags: ["rwd", "manual", "v8", "coupe", "european", "german", "redline_8k", "over_400hp", "us_market"] },
    ...
    { make: "Mercedes-Benz", model: "G-Class (W463A)", year: 2019, tags: ["awd", "v8", "turbo", "twin_turbo", "suv", "european", "german", "boxy", "six_figure", "over_400hp", "us_market"] },
    ...
    { make: "Ferrari", model: "250 GT California Spyder", year: 1957, tags: ["rwd", "manual", "big_cyl", "coupe", "convertible", "european", "italian", "mid_engine", "two_seater", "limited_run", "us_market"] },
    ...
    { make: "Aston Martin", model: "DB5", year: 1964, tags: ["rwd", "manual", "coupe", "european", "british", "james_bond", "limited_run", "us_market"] },
    ...
    { make: "Peugeot", model: "205 GTI", year: 1986, tags: ["fwd", "manual", "hatchback", "european", "lightweight"] },
    { make: "Volvo", model: "240 (200 Series)", year: 1990, tags: ["rwd", "manual", "sedan", "european", "boxy", "us_market"] },
